...
public class GetOffersByUserAction extends AbstractAction{
	...
	public void execute() {
		...
		ArrayList messages = Message.getMessage(lastChild, MAX_MESSAGE, userProp.getProperty(GoogleKeys.KEY_ID));
