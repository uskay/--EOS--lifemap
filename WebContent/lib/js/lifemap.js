...
*********************************************************/ 
	...
	function initialize() {
		...
		marker_Elementary[4] = 
			"Yusuke moved to Battle Creek, Michigan when he was 7 do to his father's job." +
...
*********************************************************/ 
	...
	function showDM(){
		...
		LinkedIn[4] = "http://www.linkedin.com/profile/view?id=120608901&trk=hb_tab_pro_top";
		var DM = Array(4);
		DM[0] = GooglePlus;
		DM[1] = Facebook;
		DM[2] = Twitter;
